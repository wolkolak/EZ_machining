...
def change_settins(names):
    ...
    print('in change_settins names: ', names)
    try:
        with fileinput.FileInput('Settings\settings.py', inplace=True, backup='.bak', openhook=fileinput.hook_encoded("utf-8")) as settings:
