from PyQt5.QtWidgets import QAction, QApplication, QDialog, QGridLayout, QFrame, QLabel, QLineEdit, QPushButton, QListWidget, QListWidgetItem
from PyQt5.QtGui import QIcon, QPixmap, QDoubleValidator
from Menus.EditMenu import add_action
from PyQt5 import QtCore
from PyQt5.QtCore import Qt
from Settings.settings import draft_page_format, scaling_draft_prime
import re
...
def tools_menu_opt(self):
    ...
    self.changePointAndScaleAction = QAction(QIcon('icons/open.png'), 'Draft propery', self)
...
class draft_dialog(QDialog):
    ...
    def done(self, a0: int) -> None:
        print('happining')
        self.scene0.behavior_mode = ''
        self.scene0.new_dot1 = None
        self.scene0.new_dot2 = None
