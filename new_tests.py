...
R12 = 360./R7#(step angle)
R13 = math.atan(( R5 - R6) / (R3 - R4)) #(ANGLE FASK)
R14 = math.sin(90-R13)*R8 #(Z from C_R to contact dot)
R15 = math.cos(90-R13)*R8 #(X from C_R to contact dot)

R16 = 1 / math.tan(R13) * (R8 - R14) - R8 #(Xdelta )

#;R5 = R5 + R16 #(increace R1 geometry for RendTool)

#;IF (R11 EQ 1) GOTO 100
#;R6 = R6 + R16
#;N100
#;IF (R11 EQ 0) GOTO 150
#;R4 = R4 - R8 + R14
#;R6 = R6 + R15 + R8
#;N150
