...
class KineticMachine(ABC):
    def __init__(self):
        self.HeadA = {'L_stage': 200, 'Angle': 0, 'Order': 0} #L_stage - mm from start of the stage to the center of the next revolution
        self.HeadB = {'L_stage': 200, 'Angle': 0, 'Order': 1} #todo should add some starting point delta
        self.HeadC = {'L_stage': 200, 'Angle': 0, 'Order': 2}

        self.TableA = {'L_stage': 200, 'Angle': 0, 'Order': 0}
        self.TableB = {'L_stage': 200, 'Angle': 0, 'Order': 1}
        self.TableC = {'L_stage': 200, 'Angle': 0, 'Order': 2}
