...
class Fanuc_NT(ReversalPostProcessor0):#ReversalPostProcessor0
    ...
    def G54_G59(self, lineBlock, nya, np_line, count, g_modal, i):
        ...
        np_line[16] = 1
        SC = nya.captured(2)
        #print('nya.captured(ff) = ', nya.captured(1))
        #print('len(nya.captured(1)) = ', len(nya.captured(1)))
        start1 = nya.capturedStart(1)
        #end1 = nya.capturedEnd(0)
        self.redactor.g_modal.insert_in_main_gmodal('SC', count + self.redactor.editor.min_line_np, '5'+SC)
