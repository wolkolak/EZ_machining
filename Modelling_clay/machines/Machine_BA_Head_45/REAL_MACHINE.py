...
class REAL_MACHINE(Machine):
    def __init__(self, *args, **kwargs):
        ...
        self.ax_order = 'CBA'
        self.m_zero_to_m_1ax_center_CONST = [0., 0., 350.]#todo смещает серую точку от места крепления головы. Визуально - когда иначе не видно.
        ...
        self.collet = {'angle': 0., 'baseR': 60.,  # angle around X, seems
